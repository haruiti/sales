    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="row">
                ...
                <input name="cep" id="cep" class="form-control" onblur="pesquisacep(this.value);">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    ...
                    <div class="input-group">
                        <select name="produto" id="produto" class="js-example-basic-single form-control" style="width: 100%">
